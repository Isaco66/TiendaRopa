<%-- 
    ...
    Created on : 3/06/2021, 12:08:24 AM
    Author     : kokob
--%>
    ...
    <body class="form-v10">
        <div class="page-content">
            <div class="form-v10-content">
                <form:form method="post" class="form-detail" action="guardar.htm">
                    <div class="form-left">
                    ...
                    <div class="form-right">
                        ...
                        <div class="form-row" style="text-align: center">
                            <div class="form-group">
                                ...
                                <div class="form-row-2 form-row">
                                    <input type="submit" name="register" class="register" value="Registrar Articulo">
                                </div>
                            </div>
                        </div>
                    </div>
